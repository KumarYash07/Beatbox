...
masterPlay.addEventListener('click', () => {
    if (audioElement.paused || audioElement.currentTime <= 0) {
        ...
        // Update the play/pause icon in the song list for the current song
        makeAllPlays();
        const currentSongItemPlay = document.getElementById(songIndex); // Get the current song's play icon
        ...
        currentSongItemPlay.classList.remove('fa-pause-circle');
        currentSongItemPlay.classList.add('fa-play-circle');
    }
});
...
// Modify the 'ended' event for looping functionality
audioElement.addEventListener('ended', () => {
    if (isLoopEnabled) {
        ...
        // Update song and play the next song
        songIndex += 1;
        ...
        // Update play/pause icon in the song list
        makeAllPlays();
